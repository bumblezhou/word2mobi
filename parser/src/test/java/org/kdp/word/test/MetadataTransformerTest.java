...
public class MetadataTransformerTest {
    ...
    public void testMetaGenerator() throws Exception {
        ...
        Assert.assertTrue("Contains word2mobi", result.contains("Microsoft Word 14 (filtered) - word2mobi"));
    }
    ...
    public void testMetaContentType() throws Exception {
        ...
        String result = parser.process(infile);
        //System.out.println(result);
        Assert.assertTrue("Contains utf-8", result.contains("text/html;charset=utf-8"));
    }
}
